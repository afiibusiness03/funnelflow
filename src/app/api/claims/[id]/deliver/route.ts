...
export async function POST(_req: Request, { params }: { params: { id: string } }) {
  ...
  // Load submission with promotion + tenant and verify tenant ownership
  ...
  if (!submission || submission.tenant_id !== userData.tenant_id) {
  ...
  if (promo && submission.customer_email) {
    try {
      ...
      console.error('Re-delivery email error:', err)
    }
  }
